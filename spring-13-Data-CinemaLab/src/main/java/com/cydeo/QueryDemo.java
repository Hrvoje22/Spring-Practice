...
public class QueryDemo implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println(userRepository.fetchByEmailJPQL("bernard@email.com"));
        System.out.println(userRepository.fetchAllUsers());
        System.out.println(userRepository.retrieveAllByName("ber"));
        System.out.println(userRepository.retrieveBetweenAgeRange(20,40));
        System.out.println(userRepository.retrieveByEmail("lawrence.f@email.com"));
    }
}
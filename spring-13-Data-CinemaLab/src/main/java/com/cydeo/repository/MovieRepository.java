...
public interface MovieRepository extends JpaRepository<Movie, Long> {
    ...
    @Query("SELECT DISTINCT m.name FROM Movie m") //distinct not needed
    ...
    List<Movie> retrieveByRange(@Param("price1") BigDecimal price1,@Param("price2") BigDecimal price2);

    //Write a native query to return all movies where duration exists in the range of duration //it can go with IN or BETWEEN
